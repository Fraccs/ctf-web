  ...
  return (
    <main className="h-full flex flex-col items-center justify-center gap-16 bg-zinc-950">
      ...
      <div className="w-full flex items-center justify-center gap-16">
        ...
        <Link href={`/competitions/${sha}`} className="px-4 py-2 rounded-lg bg-gradient-to-br from-red-600 via-rose-600 to-red-500 font-bold text-center text-white shadow-2xl drop-shadow-2xl shadow-rose-600 hover:opacity-90">
          Competitions
        </Link>
      </div>
    </main>
